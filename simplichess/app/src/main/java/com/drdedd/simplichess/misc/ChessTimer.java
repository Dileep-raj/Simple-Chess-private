...
public class ChessTimer {
    ...
    public ChessTimer(GameLogicInterface gameLogicInterface, Context context, TextView whiteTimeTV, TextView blackTimeTV, long millis) {
...
//        this.blackLayout = blackLayout;
    ...
    public ChessTimer(GameLogicInterface gameLogicInterface, Context context, TextView whiteTimeTV, TextView blackTimeTV, TimeControl timeControl) {
        this.context = context;
        this.whiteTimeTV = whiteTimeTV;
        this.blackTimeTV = blackTimeTV;
        this.gameLogicInterface = gameLogicInterface;
    ...
    public void newTimer(long timeLeft) {
        ...
        timer = new CountDownTimer(timeLeft, 100) {
            ...
            public void onFinish() {
                stopTimer();
                gameLogicInterface.terminateByTimeOut(gameLogicInterface.isWhiteToPlay() ? Player.WHITE : Player.BLACK);
            }
        }.start();
    }
